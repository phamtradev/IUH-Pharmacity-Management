...
public class GD_QuanLyKhuyenMai extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cboLoaiKhuyenMai
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Sản phẩm", "Đơn hàng" }));
                ...
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(btnXoa, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(10, 10, 10)
                                .addComponent(btnXemChiTiet, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtMaKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 180,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20)
                                .addComponent(cboLoaiKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 180,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(20, 20, 20)
                        ...
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                                        ...
                                        .addComponent(txtMaKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cboLoaiKhuyenMai, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnTimKiem, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnThemActionPerformed
        ...
        ThemKhuyenMaiDialog dialog = new ThemKhuyenMaiDialog((java.awt.Frame) SwingUtilities.getWindowAncestor(this),
                true);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSuaActionPerformed
        ...
        SuaKhuyenMaiDialog dialog = new SuaKhuyenMaiDialog((java.awt.Frame) SwingUtilities.getWindowAncestor(this),
                true, kmCanSua);
        dialog.setVisible(true);
    ...
    private void btnXemChiTietActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnXemChiTietActionPerformed
        ...
        XemChiTietKhuyenMaiDialog dialog = new XemChiTietKhuyenMaiDialog(
                (java.awt.Frame) SwingUtilities.getWindowAncestor(this), true, kmCanXem);
        dialog.setVisible(true);
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (danhSach.isEmpty()) {
            ...
            Notifications.getInstance().show(Notifications.Type.SUCCESS,
                    "Tìm thấy " + danhSach.size() + " khuyến mãi!");
        }
