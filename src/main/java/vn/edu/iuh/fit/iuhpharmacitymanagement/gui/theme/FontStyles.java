...
public final class FontStyles {
    ...
    /**
     * Chuyển đổi văn bản của các nút (JButton, JCheckBox...) thành IN HOA. Hàm
     * này an toàn, không lỗi nếu nút chưa có text hoặc null.
     */
    ...
    /**
     * Chuyển toàn bộ text của component sang chữ hoa. Dùng cho label, button,
