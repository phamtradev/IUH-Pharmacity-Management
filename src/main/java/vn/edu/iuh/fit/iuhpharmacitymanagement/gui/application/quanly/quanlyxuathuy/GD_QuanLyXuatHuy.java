...
public class GD_QuanLyXuatHuy extends javax.swing.JPanel {
    ...
    private void applyButtonStyles() {
        // Apply ButtonStyles cho các button
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout modalPurchaseOrderDetailLayout = new javax.swing.GroupLayout(
                modalPurchaseOrderDetail.getContentPane());
                ...
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(jDateTo, javax.swing.GroupLayout.PREFERRED_SIZE, 210,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 210,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(txtOrder, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (hangHongs.isEmpty()) {
            ...
            Notifications.getInstance().show(Notifications.Type.SUCCESS,
                    "Tìm thấy " + hangHongs.size() + " phiếu xuất hủy!");
        }
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnViewActionPerformed
        ...
        for (ChiTietHangHong chiTiet : chiTietHangHongs) {
            ...
            if (productMap.containsKey(productKey)) {
                // Nếu chi tiết đã tồn tại trong Map (cùng lô, cùng lý do), cộng dồn số lượng và
                // thành tiền
                ...
                // Nếu chi tiết chưa tồn tại trong Map (khác lô hoặc khác lý do), thêm mới vào
                // Map
        ...
        String[] columnNames = { "STT", "Hình ảnh", "Tên sản phẩm", "Lô hàng", "HSD", "Đơn vị", "Số lượng", "Đơn giá",
                "Thành tiền", "Lý do" };
        ...
        for (ChiTietHangHong chiTiet : productMap.values()) {
            if (chiTiet.getLoHang() != null && chiTiet.getLoHang().getSanPham() != null) {
                ...
                tableModel.addRow(new Object[] { stt++, imageIcon, tenSP, maLoHang, hsd, donVi, soLuong, donGia,
                        thanhTien, lyDo });
            }
        }
        ...
        tableDetail.getColumnModel().getColumn(1)
                .setCellRenderer(new vn.edu.iuh.fit.iuhpharmacitymanagement.common.ImageTableCellRenderer());
