...
public class GD_QuanLyDonHang extends javax.swing.JPanel {
    ...
    private void fillTable() {
        String[] headers = { "Mã hóa đơn", "Ngày tạo", "Khuyến mãi", "Tổng tiền", "Thanh toán", "Khách hàng",
                "Nhân viên" };
    ...
    private void fillContent(List<DonHang> donHangs) {
        ...
        for (DonHang donHang : donHangs) {
            ...
            tableDesign.getModelTable().addRow(new Object[] {
                    ...
                    donHang.getPhuongThucThanhToan() == PhuongThucThanhToan.CHUYEN_KHOAN_NGAN_HANG ? "Ngân hàng"
                            : "Tiền mặt",
                    khachHang,
                ...
                jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(jDateTo, javax.swing.GroupLayout.PREFERRED_SIZE, 210,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(txtOrderCode, javax.swing.GroupLayout.PREFERRED_SIZE, 200,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void showChiTietDonHangDialog(String maDonHang) {
        ...
        // ===================== TABLE CHI TIẾT =====================
        String[] headers = { "STT", "Mã lô hàng", "Tên sản phẩm", "Đơn vị", "Số lượng", "Đơn giá", "Giảm giá",
                "Thành tiền" };
