...
public class GD_QuanLyNhaCungCap extends javax.swing.JPanel {
        ...
        private void setUIManager() {
                ...
                txtSupPhoneAdd.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT,
                ...
                txtSupTaxCodeAdd.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT,
                ...
                txtSupPhoneEdit.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT,
                                "Nhập số điện thoại (10 chữ số)");
        ...
        private void initComponents() {
                ...
                javax.swing.GroupLayout modelSupplierAddLayout = new javax.swing.GroupLayout(
                                modelSupplierAdd.getContentPane());
                ...
                pnlTieuDe.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 0, 2, 0,
                ...
                layout.setHorizontalGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(pnAll, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE));
                ...
                try {
                        ...
                        if (danhSachNCC.isEmpty() && !keyword.isEmpty()) {
                                Notifications.getInstance().show(Notifications.Type.INFO,
                                                Notifications.Location.TOP_CENTER, 2000,
                ...
                try {
                        ...
                        if (tenNCC.isEmpty()) {
                                Notifications.getInstance().show(Notifications.Type.WARNING,
                                                Notifications.Location.TOP_CENTER, 2500,
                        ...
                        if (success) {
                                ...
                                clearData(txtSupNameEdit, txtSupPhoneEdit, txtSupEmailEdit, txtSupAddressEdit,
                                                txtSupTaxCodeEdit);
                                ...
                                Notifications.getInstance().show(Notifications.Type.ERROR,
                                                Notifications.Location.TOP_CENTER, 3000,
        ...
        private void btnSupplierAddActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSupplierAddActionPerformed
                try {
                        ...
                        if (success) {
                                ...
                                // Clear form và đóng modal
                                clearData(txtSupNameAdd, txtSupPhoneAdd, txtSupEmailAdd, txtSupAddressAdd,
                                                txtSupTaxCodeAdd);
                                modelSupplierAdd.dispose();
