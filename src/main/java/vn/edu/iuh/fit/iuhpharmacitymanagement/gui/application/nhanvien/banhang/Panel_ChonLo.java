...
public class Panel_ChonLo extends javax.swing.JPanel {
    ...
    public Panel_ChonLo(LoHang loHang) {
        this.loHang = loHang;
        initComponents();
        loadLoHangData();
    }
    ...
    private void loadLoHangData() {
        if (loHang != null) {
            txtBatch.setText("Lô: " + loHang.getTenLoHang());
            txtExpiry.setText("HSD: " + loHang.getHanSuDung().format(formatter));
            txtQuantity.setText("Tồn: " + loHang.getTonKho());
            
            // Đổi màu nếu hết hạn hoặc sắp hết hạn
            if (!loHang.isTrangThai()) {
                txtExpiry.setForeground(new java.awt.Color(220, 53, 69)); // Đỏ nếu hết hạn
            }
        }
    }
