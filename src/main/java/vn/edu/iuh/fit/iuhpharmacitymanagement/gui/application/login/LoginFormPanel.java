...
public class LoginFormPanel extends javax.swing.JPanel {
    ...
    public LoginFormPanel() {
        ...
        // txtTenDangNhap.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON,
        // new com.formdev.flatlaf.extras.FlatSVGIcon("img/user_icon.svg"));
        // txtMatKhau.putClientProperty(FlatClientProperties.TEXT_FIELD_LEADING_ICON,
        // new com.formdev.flatlaf.extras.FlatSVGIcon("img/password_icon.svg"));
    ...
    private void applyStyles() {
        // Apply ButtonStyles cho button đăng nhập
        ButtonStyles.apply(btnDangNhap, ButtonStyles.Type.PRIMARY);

        // Apply FontStyles
        FontStyles.apply(btnDangNhap, FontStyles.Type.BUTTON_LARGE);
        FontStyles.apply(txtTenDangNhap, FontStyles.Type.INPUT_FIELD);
        FontStyles.apply(txtMatKhau, FontStyles.Type.INPUT_FIELD);
        FontStyles.apply(lblTieuDe, FontStyles.Type.HEADING_MEDIUM);
        FontStyles.apply(lblQuenMatKhau, FontStyles.Type.TEXT_SMALL);
    }
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        // javax.swing.JFrame parentFrame = (javax.swing.JFrame)
        // SwingUtilities.getWindowAncestor(this);
        //
        // try {
        // ConnectDB.getConnection();
        // } catch (SQLException ex) {
        // System.getLogger(LoginFormPanel.class.getName()).log(System.Logger.Level.ERROR,
        // (String) null, ex);
        // }
        // if (txtTenDangNhap.getText().trim().isEmpty() ||
        // txtTenDangNhap.getText().trim().length() == 0) {
        ...
        // return;
        // }
        // Optional<String> optVaiTro =
        // tkDao.tonTaiTaiKhoanKhiLogin(txtTenDangNhap.getText(),
